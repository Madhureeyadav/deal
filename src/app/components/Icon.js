"use client";
import AreaPart1 from './AreaPart1'
...
const FarmhouseImage =() => {
    ...
    return (
    //   
    <div className="container mx-auto my-8"> {/* Added relative class here */}
      <h1 className="text-3xl text-center font-semibold mb-4">Farmhouse Properties</h1>
        ...
        {farmhouseData.map((property) => (
          <div key={property.id} className="bg-white rounded p-4 shadow-md ">
            <div>
              ...
              />
              <AreaPart1 /> {/* Updated AreaPart to use relative positioning */}
            </div>
            ...
            <p>
              {property.bedrooms} Bedrooms {property.bathrooms} Bathrooms {property.squareFeet} square Ft
            </p>
            <p className="text-lg font-bold text-orange-400 p-2 m-2 border-t border-b">{property.price}</p>
            <Feed/>
          </div>
        ))}
